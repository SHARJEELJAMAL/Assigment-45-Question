...
and titlecase.
*/
let person_name = 'sharjeel jamal'
...
*/
let famous_person = 'Winston Churchil'
let quote = '"If you are going through hell, keep going."'
...
let myName: string = "Sharjeel Jamal";
...
let names: string[] = ["Akif", "Munib", "Raheel"];
...
*/
let Names: string[] = ["Honey", "Ahmed", "Fahim"];
...
*/
let transport: string[] = ["Suzuki Motorcycle", "BMW Car", "Banaweer Bicycle"]
...
*/
let guest: string[] = ["ghufran", "muneeb", "emad"]
guest.forEach(guest => {
...
*/
let guests: string[] = ["Imran", "Sameer", "Bilal"];
...
• Sort to change your array so it’s stored in reverse alphabetical order. Print the list to show that its order
 has changed.
*/
let places: string[] = ["Saudi Arabia", "United Kingdom", "Germany", "Switzerland", "Finand"];
...
*/
let Guest: string[] = ["Imran", "Sameer", "Bilal", "Ali", "Adda"];
...
these items.
*/
let Places: string[] = ["Mariana Trench", "Singapore", "London", "Niagra falls"]
...
*/
let current_users: string[] = ["user 1", "admin", "user 3", "user 4", "user 5"];
let new_users: string[] = ["User 1", "User 6", "user 7", "admin", "User 9"];
...
function make_great(magicians: string[]): string[] {//@ts-ignore
    let greatMagicians = [];
    magicians.forEach(magician => {
